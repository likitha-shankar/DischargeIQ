...
| 6.2 | Production builds (locked deps, release iOS/Android) | ◑ - Python deps locked (`requirements.lock.txt`); Dart lock + release iOS/Android on the paid-hold list (Apple enrollment / Play account) |
