# Task 1.10 (was 2.5) - Android Beta Distribution (direct-install APK) ✅

> Renamed from task-2.5.md (July 7 numbering): the Android beta task is 1.10
> in Work Plan v2; task 2.5 is now the iOS access research (see task-2.5.md).
